...
function parseClaudeTokens(output: string): { inputTokens: number; outputTokens: number } {
  let inputTokens = 0;
  let outputTokens = 0;
...
{"type":"result","input_tokens":200,"output_tokens":100}`;
...
More text here
{"type":"result","input_tokens":5000,"output_tokens":2500}
Final output`;
